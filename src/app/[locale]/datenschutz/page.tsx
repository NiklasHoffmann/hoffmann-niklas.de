                ...
                <div className="space-y-8">
                    ...
                    >
                        <h2
                            ...
                            style={{ color: isDark ? '#ffffff' : '#111827' }}
                        >
                            <Icon icon="mdi:database" className="w-6 h-6 text-accent" />
                    ...
                    >
                        <h2
                            ...
                            style={{ color: isDark ? '#ffffff' : '#111827' }}
                        >
                            <Icon icon="mdi:cookie" className="w-6 h-6 text-accent" />
                            {t('cookies.title')}
                        </h2>
                        <p style={{ color: isDark ? '#d1d5db' : '#4b5563' }}>
                            {t('cookies.content')}
                    ...
                    >
                        <h2
                            ...
                            style={{ color: isDark ? '#ffffff' : '#111827' }}
                        >
                            <Icon icon="mdi:shield-account" className="w-6 h-6 text-accent" />
                            {t('rights.title')}
                        </h2>
                        <div
                            className="space-y-2"
