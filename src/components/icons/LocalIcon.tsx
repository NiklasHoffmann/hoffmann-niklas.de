...
const ICON_MAP: Record<string, { file: string; colored?: boolean }> = {
    ...
    'lucide:moon': { file: 'ui-moon' },
    'lucide:sun': { file: 'ui-sun' },
    'lucide:sparkles': { file: 'ui-sparkles' },
    'lucide:mail': { file: 'ui-mail' },
    'lucide:map-pin': { file: 'ui-map-pin' },
    'lucide:loader-2': { file: 'ui-loader' },
    'lucide:check-circle': { file: 'ui-check-circle' },
    'lucide:alert-circle': { file: 'ui-alert-circle' },
    'lucide:x': { file: 'ui-x' },
    'lucide:instagram': { file: 'ui-instagram' },
    'lucide:arrow-left': { file: 'ui-arrow-left' },
    'lucide:trending-up': { file: 'ui-trending-up' },
    'lucide:users': { file: 'ui-users' },
    'lucide:clock': { file: 'ui-clock' },
    'lucide:eye': { file: 'ui-eye' },
    'lucide:mouse-pointer-click': { file: 'ui-mouse-click' },
    'lucide:monitor': { file: 'ui-monitor' },
    'lucide:smartphone': { file: 'ui-smartphone' },
    'lucide:globe': { file: 'ui-globe' },
    'lucide:bar-chart-3': { file: 'ui-bar-chart' },
    'lucide:activity': { file: 'ui-activity' },
    'lucide:tablet': { file: 'ui-tablet' },
